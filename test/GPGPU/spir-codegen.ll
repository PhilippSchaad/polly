; RUN: opt %loadPolly -polly-target=gpu \
; RUN: -polly-gpu-arch=spir32 -polly-codegen-ppcg \
...
; CHECK-LABEL: define spir_kernel void @FUNC_double_parallel_loop_KERNEL_0(i8 addrspace(1)* %MemRef_A) #0 !kernel_arg_addr_space !0 !kernel_arg_name !1 !kernel_arg_access_qual !1 !kernel_arg_type !1 !kernel_arg_type_qual !1 !kernel_arg_base_type !1 {
; CHECK-NEXT: entry:
